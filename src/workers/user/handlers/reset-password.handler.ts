...
import { JobMessagingType, type IResetPasswordPayload } from '@volontariapp/messaging';
import type { Job } from 'bullmq';
import type { IJobHandler } from '../../job-handler.interface.js';

@Injectable()
export class ResetPasswordHandler
  implements IJobHandler<typeof JobMessagingType.RESET_PASSWORD>
{
  ...
  async handle(job: Job<IResetPasswordPayload>): Promise<void> {
    ...
    // TODO: call email service with reset link
    void token;
